...
int	main(int argc, char **argv)
{
	...
	std::cout<< "long_min: " << std::fixed << std::setprecision(1) << std::numeric_limits<long>::min() << std::endl;
	std::cout << "long_max: " << std::fixed << std::setprecision(1) << std::numeric_limits<long>::max() << std::endl;
